            ...
            <form method="POST">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra ₹ 2110 Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">USN</h4>
                                        <div class="form-group">
                                            <input type="text" name="regno" id="regno" placeholder="Enter USN" class="form-control" required>
                                        </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Preferred Department</h4>
                                    <div class="form-group mb-4">
